                            ...
                            <c:when test="${Caso.getCodigocaso() == sessionScope.codigoCaso}">
                                ...
                                <form method="post" name="cambiarEstado" id="Caso" action="">
                                    <div class="form-group">
                                        ...
                                        <input  name="usuarioEstado" class="form-control"  type="hidden" value="<c:out value="${sessionScope.USUARIO.getNombreUsuario()}"/> <c:out value="${sessionScope.USUARIO.getApellidoUsuario()}"/>">
                                        <input  name="codigoCaso" class="form-control"  type="hidden" value="<c:out value='${Caso.getCodigocaso()}' />">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group"> 
                                        <textarea class="form-control" rows="5" id="comentariosEstado" name="comentariosEstado" ></textarea>
                                    </div>
